...
class Extent : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:chromeos_update_engine.Extent) */ {
 public:
  ...
  inline Extent* New() const PROTOBUF_FINAL { return New(NULL); }

  Extent* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  void set_has_start_block();
  void clear_has_start_block();
  void set_has_num_blocks();
  void clear_has_num_blocks();
  ...
  friend struct protobuf_update_5fmetadata_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class Signatures_Signature : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:chromeos_update_engine.Signatures.Signature) */ {
 public:
  ...
  inline Signatures_Signature* New() const PROTOBUF_FINAL { return New(NULL); }

  Signatures_Signature* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
...
class ImageInfo : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:chromeos_update_engine.ImageInfo) */ {
 public:
  ...
  #if LANG_CXX11
  void set_build_channel(::std::string&& value);
  #endif
 ...
 private:
  ...
  void set_has_version();
  void clear_has_version();
  void set_has_build_channel();
  void clear_has_build_channel();
  void set_has_build_version();
  void clear_has_build_version();
...
class InstallOperation : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:chromeos_update_engine.InstallOperation) */ {
 public:
  ...
  inline InstallOperation* New() const PROTOBUF_FINAL { return New(NULL); }

  InstallOperation* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
  ...
  static const Type IMGDIFF =
    InstallOperation_Type_IMGDIFF;
 ...
 private:
  void set_has_type();
  void clear_has_type();
  void set_has_data_offset();
  void clear_has_data_offset();
  void set_has_data_length();
  void clear_has_data_length();
  void set_has_src_length();
  void clear_has_src_length();
  void set_has_dst_length();
  void clear_has_dst_length();
  void set_has_data_sha256_hash();
  void clear_has_data_sha256_hash();
  void set_has_src_sha256_hash();
  void clear_has_src_sha256_hash();
...
class PartitionUpdate : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:chromeos_update_engine.PartitionUpdate) */ {
 public:
  ...
  inline PartitionUpdate* New() const PROTOBUF_FINAL { return New(NULL); }

  PartitionUpdate* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
 ...
 private:
  void set_has_partition_name();
  void clear_has_partition_name();
  void set_has_run_postinstall();
  void clear_has_run_postinstall();
  void set_has_postinstall_path();
  void clear_has_postinstall_path();
  void set_has_filesystem_type();
  void clear_has_filesystem_type();
  void set_has_old_partition_info();
  void clear_has_old_partition_info();
  void set_has_new_partition_info();
  void clear_has_new_partition_info();
  void set_has_postinstall_optional();
  void clear_has_postinstall_optional();
...
class DeltaArchiveManifest : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:chromeos_update_engine.DeltaArchiveManifest) */ {
 public:
  ...
  inline DeltaArchiveManifest* New() const PROTOBUF_FINAL { return New(NULL); }

  DeltaArchiveManifest* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
 ...
 private:
  ...
  void set_has_signatures_offset();
  void clear_has_signatures_offset();
  void set_has_signatures_size();
  void clear_has_signatures_size();
  void set_has_old_kernel_info();
  void clear_has_old_kernel_info();
  void set_has_new_kernel_info();
  void clear_has_new_kernel_info();
  void set_has_old_rootfs_info();
  void clear_has_old_rootfs_info();
  void set_has_new_rootfs_info();
  void clear_has_new_rootfs_info();
  void set_has_old_image_info();
  void clear_has_old_image_info();
  void set_has_new_image_info();
  void clear_has_new_image_info();
